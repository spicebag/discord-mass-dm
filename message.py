...
Cls()
b = Style.BRIGHT
print(colored('Created by', 'red'), colored('https://github.com/spicebag', 'green'))
...
{b+Fore.WHITE} > {Fore.RESET}Created by Spicebag
{b+Fore.ORANGE} > {Fore.RESET}https://github.com/spicebag
""")
...
async def on_connect():
  for user in watch.user.friends:
    try:
      ...
      watchy.set_author(name="Check out my Github https://github.com/spicebag ")
      watchy.add_field(name="Mass-DM Tool created by Spicebag.",value=message)
      watchy.set_image(url="https://images.gram.pl/article/fjkf20220912173703187odmx.jpg")
